...
def predict():
    ...
    if request.method == 'POST':
        # print(request.form)  # parse as JSON
        ...
        print(data.has_key(("action")))
        # for genre in extra_features_df.columns[1:]:
        #     # print(genre)
        #     # print(type(genre))
        #     if data.has_key(genre):
        #         print(f"{genre} is selected")
        #         # extra_features_df.loc[0,genre] = 1
        #     else:
        #         print(f"{genre} is not selected")
        #         # pass
